...
class SearchCustomer:
    ...
    def searchCustomerByEmail(self,email):
        ...
        for r in range(1,self.getNoOfRows()+1):
          ...
          emailid=table.driver.find_element(By.XPATH, "//table[@id='customers-grid']/tbody/tr["+str(r)+"]/td[2]").text
          if emailid == email:
              flag = True
              break
        return flag
    ...
    def searchCustomerByName(self,Name):
        ...
        for r in range(1,self.getNoOfRows()+1):
          table=self.driver.find_element(By.XPATH, self.table_xpath)
          name=table.driver.find_element(By.XPATH, "//table[@id='customers-grid']/tbody/tr["+str(r)+"]/td[3]").text
          if name == Name:
              flag = True
              break
        return flag
